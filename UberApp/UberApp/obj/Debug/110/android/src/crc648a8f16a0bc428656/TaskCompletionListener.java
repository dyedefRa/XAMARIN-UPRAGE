...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("UberApp.Helper.TaskCompletionListener, UberApp", TaskCompletionListener.class, __md_methods);
	}
	...
	public TaskCompletionListener ()
	{
		...
		if (getClass () == TaskCompletionListener.class)
			mono.android.TypeManager.Activate ("UberApp.Helper.TaskCompletionListener, UberApp", "", this, new java.lang.Object[] {  });
	}
